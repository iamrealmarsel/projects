...
$(document).ready(function(){
  ...
  $("body").on('mouseleave', function () {
    if (!($('#callBackForm-1').hasClass('in')) && !($('#callBackForm-2').hasClass('in')) && !($('#callBackForm-4').hasClass('in')) && !($('#callBackForm-5').hasClass('in')) && !($('#callBackForm-12').hasClass('in')) && !($('#callBackForm-7').hasClass('in')) && !($('#callBackForm-8').hasClass('in')) && !($('#callBackForm-6').hasClass('in'))) {
      if (ModalOpenIndex === 0) {

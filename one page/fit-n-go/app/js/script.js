...
$('.burger').on('click', function() {
  $(this).closest('.header__head').addClass('active');
  $('body').addClass('overflow');
});

$('.burger--open').on('click', function() {
  $(this).closest('.header__head').removeClass('active');
...
// faq
$('.faq__cnt').nextAll().hide();

$('.faq__tab').on('click', function(e) {
  e.preventDefault();
  var i = $(this).index();
  $('.faq__tab').siblings().removeClass('active')
  $(this).addClass('active');
  $('.faq__cnt').hide().eq(i).show();

});


// цены
$('.prices__subtitle').on('click', function() {

	if ($(this).next('.prices__block').hasClass('active')) {
		return;
	}

	$(this).closest('.prices').find('.prices__block.active').slideUp().removeClass('active');
	$(this).next('.prices__block').slideDown().addClass('active');
	$(this).closest('.prices').find('.prices__subtitle').addClass('fa-angle-down').removeClass('fa-angle-up');
...
// баннер
// setTimeout(function() {
//   $('.header__coupon').trigger('click');
// }, 10000);

// $('.modal__img').on('click', function() {

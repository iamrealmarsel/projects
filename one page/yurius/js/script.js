...
$('.burger').on('click', function() {
  ...
  // $('.header__navMob').css('padding-top', headerH);

  $('body').addClass('overflow');
  $('.header__navMob').addClass('active');
...
$('.burger--open').on('click', function() {
  ...
  $('.header__navMob').removeClass('active');
...
$('.faq__subtitle').on('click', function() {
  ...
  $(this).siblings('.faq__text').slideToggle();
...
$('.js-close, .modalOverlay').on('click', function(e) {
...
$('.header__nav a, .footer__nav a').on('click', function(e) {
...
$('.header__navMob a').on('click', function(e) {
